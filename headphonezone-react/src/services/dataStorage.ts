// Basic type definitions - can be expanded later if needed

interface Product {
  id: number; // Added unique ID
  image1: string;
  image2: string; // Assuming image2 is always present, otherwise string | undefined
  title: string;
  subtitle: string;
  price: string;
  price2: string; // Assuming price2 is always present, otherwise string | undefined
  rating: string; // Assuming rating is always present, otherwise string | undefined
}
...
// Removed unused Logo and SlideShowImage interfaces

const dealsArr: Product[] = [
   {
      id: 1, // Added ID
...
// Exporting the arrays directly
export const slideshowsData: Slide[] = slideshow_content;
export const dealsData: Product[] = dealsArr;
export const trendingData: Product[] = trendingArr;
export const newLaunchesData: Product[] = newLaunchesArr;
export const wfhData: Product[] = wfhArr;
export const unboxedData: Product[] = unboxedArr;
export const logoData: string[] = logoArr;
export const slideShowData: string[] = slideShowArr;
