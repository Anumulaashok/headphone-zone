...
// ---------------------
const { ApifyClient } = require('apify_api_fn4YrMoQnnhXSMgnfHjgfEfMj2P5RF4B3qxv');

// Initialize the ApifyClient with API token
const client = new ApifyClient({
    token: 'apify_api_fn4YrMoQnnhXSMgnfHjgfEfMj2P5RF4B3qxv',
});
// https://api.apify.com/v2/actor-tasks?token=apify_api_fn4YrMoQnnhXSMgnfHjgfEfMj2P5RF4B3qxv
// Prepare actor input
const input = {
    "proxyConfig": {
        "useApifyProxy": true
